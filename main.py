...
from routers import finanzas, inventario,areati, carga,panel,electrolux, transyanez, reportes_cargas, pedidos, productos, rutas, recepcion, comunas, clientes, toc , rsv, beetrack, easy,logistica_inversa,seguridad, meli , operaciones, venta_traspaso, CamaraPpu,taskmaster,editar_ruta
...
app.include_router(editar_ruta.router)
